...
#define ENTITY_ID_NPC_GUARD (ENTITY_ID_FIRST_GAME + 15)
#define ENTITY_ID_NPC_MAYOR (ENTITY_ID_FIRST_GAME + 16)
#define ENTITY_ID_NPC_MERCHANT (ENTITY_ID_FIRST_GAME + 17)
#define ENTITY_ID_NPC_WIZARD (ENTITY_ID_FIRST_GAME + 18)

#define GAME_ENTITY_COUNT 19
