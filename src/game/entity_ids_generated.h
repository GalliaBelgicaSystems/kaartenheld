...
#define ENTITY_ID_DOG (ENTITY_ID_FIRST_GAME + 13)
#define ENTITY_ID_NPC_GUARD (ENTITY_ID_FIRST_GAME + 14)
#define ENTITY_ID_NPC_MAYOR (ENTITY_ID_FIRST_GAME + 15)
#define ENTITY_ID_NPC_MERCHANT (ENTITY_ID_FIRST_GAME + 16)
#define ENTITY_ID_NPC_WIZARD (ENTITY_ID_FIRST_GAME + 17)

#define GAME_ENTITY_COUNT 18
