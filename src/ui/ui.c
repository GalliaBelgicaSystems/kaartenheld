...
/* CGB OBJ ramps (OAM slots 0..3), generated from assets/palette.txt --
 * see generated/tiles/obj_tables.h. Shade 0 is transparent on hardware
 * regardless of the programmed value. */
#include "obj_tables.h"
